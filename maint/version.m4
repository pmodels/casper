...
#
# This file contains versioning information for CASPER's configure process.
...
m4_define([CASPER_VERSION_m4],[1.0b1])dnl
...
m4_define([libcasper_so_version_m4],[0:0:0])dnl

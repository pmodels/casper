                                                 ...
                                                 CSPU_win_t * ug_win, MPI_Request * request)
{
    ...
    CSP_CALLMPI(NOSTMT, PMPI_Rget_accumulate(origin_addr, origin_count, origin_datatype,
...
#define ORIG_MPI_FNC() do {                                                                  \
        CSPU_PROF_RMA_COUNTER_INC(RGET_ACCUMULATE, OFF);                                     \
                        ...
                        MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request * request)
{
    ...
    if (ug_win) {
        ...
        CSPU_PROF_RMA_COUNTER_INC(RGET_ACCUMULATE, ON);

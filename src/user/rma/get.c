...
static int get_shared_impl(void *origin_addr, int origin_count,
...
static int get_segment_impl(const void *origin_addr, int origin_count,
...
static int get_impl(void *origin_addr, int origin_count,
                    MPI_Datatype origin_datatype,
                    int target_rank, MPI_Aint target_disp,
                    int target_count, MPI_Datatype target_datatype, CSP_win_t * ug_win)
{
...
#endif
    {
        ...
        if (CSP_ENV.lock_binding == CSP_LOCK_BINDING_SEGMENT &&
            ...
            mpi_errno = get_segment_impl(origin_addr, origin_count,
